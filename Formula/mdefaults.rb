class Mdefaults < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/fumiya-kume/mdefaults/releases/download/v#{version}/mdefaults-arm64-v#{version}.zip"
    ...
    if Hardware::CPU.intel?
      url "https://github.com/fumiya-kume/mdefaults/releases/download/v#{version}/mdefaults-amd64-v#{version}.zip"
      sha256 "2781d96c9efde569901c0f99d7395759397e4d20b4767685be31fe49147afa48"
